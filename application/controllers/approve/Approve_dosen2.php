...
class Approve_dosen2 extends CI_Controller{
    ...
    public function index($nim){
        ...
        $this->load->view('approve/approve_dosen2',$data);
    }
    public function update_approveDosen2($nim){
        $approve_dosen=$this->input->post('approve_dosen');
        $cat_dosen=$this->input->post('cat_dosen');
        
        $data=array(
            'approve_dosen2'=>$approve_dosen,
            'cat_dosen2'=>$cat_dosen,
        );
