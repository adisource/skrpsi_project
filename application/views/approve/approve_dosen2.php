      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Approve Dosen </h1>
          ...
          <!-- Content Row -->
           ...
           <div class="col-lg-12">
            <div class="card mb-4 py-3 border-left-primary">
              ...
              <form action='<?php echo site_url('approve/approve_dosen2/update_approveDosen2/'.$mhs->nim)?>' method="POST">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <select class="form-control" name='approve_dosen'>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <textarea name="cat_dosen" id="" cols="20" rows="5" class='form-control'></textarea>
                    </div>
                  </div>
