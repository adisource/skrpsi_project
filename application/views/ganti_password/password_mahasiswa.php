          ...
          <!-- Content Row -->
           ...
           <div class="col-lg-12">
            <div class="card mb-4 py-3 border-left-primary">
              ...
              <form  action="<?php echo site_url('/ganti_password/password_mahasiswa/cek/').$_SESSION['nim_asuser']?>" method="POST">
                  <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">NPM</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputEmail3" 
                        placeholder="NPM" name="nim" required='required' readonly value="<?php echo $nim_mahasiswa ?>" >
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputEmail3" 
                        placeholder="Nama Mahasiswa"  required='required' readonly value="<?php echo $nama ?>">
                    </div>
                  </div>
                  <div class="form-group row">
